...
# project to 18N, EPSG = 32618
graph_proj = ox.project_graph(graph, to_crs="+proj=utm +zone=17 +ellps=WGS84 +datum=WGS84 +units=m +no_defs")
graph_simple = nx.DiGraph(graph_proj)
```
...
park_ids = park_points.sample(5).id
