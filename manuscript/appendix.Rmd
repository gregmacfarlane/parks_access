...
access_terms <- c("Size and Distance", "Tweets",  "Attributes", "10-min walk")
...
texreg(pa_models, digits = 4, ci.force = TRUE,
       ...
       custom.model.names = c("No Access", access_terms),
...
texreg(obesity_models, digits = 4, ci.force = TRUE,
       ...
       custom.model.names = c("No Access", "Size and Distance", "Twitter", "Amenities", "10-Minute Walk"),
       caption = "Estimated Effect of Accessibility on Physical Activity Rates",
       label = "tab:ob-fullmodels",
       caption.above = TRUE, include.aic = F, include.lr = F, scalebox = 0.7,
       custom.note = "%stars 95\\% confidence interval in brackets.")
```
