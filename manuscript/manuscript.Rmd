...
which many are plausible but lack robust theoretical bases. In this
...
outcomes has been focused on comparing metropolitan regions against each other.
For example, @West2012 used park data from
...
desires for physical activity. Considering access at the neighborhood level within
...
map +
  geom_sf(data = tracts, inherit.aes=FALSE,
          aes(fill = cut(access_ls, breaks = c(-Inf, -3, -2, -1, 0, 1, 2, 3, Inf))),
          alpha = 0.9, color = NA) +
